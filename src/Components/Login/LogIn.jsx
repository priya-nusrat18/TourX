        ...
        <Container>
          <div className="text-center">
            <h2 className="login-title">
              Welcome To <br /> TourX-TravelTourism Agency
            </h2>
            ...
            <div className="login-area my-3 text-center">
              ...
              >
                <p className="text-center text-danger">
                  Alert! Continue with Google. <br /> If You Continue with Admin
                  Email for test only.But Don't Abuse!{" "}
                </p>
                <h1>Login Here</h1>
                <br />
                <input
                ...
                />
                <button
                  onClick={handleAlertToast}
                  type="submit"
                  className="support-btn mb-2"
                >
                  Login
                </button>
              </form>
          ...
          <div className="social-login-option text-center">
            ...
            <button className="google-btn my-3 " onClick={googleSignIn}>
              <span className="support-color2">
                <FontAwesomeIcon
                  className="google support-color2"
                  icon={faGoogle}
                />
              </span>{" "}
